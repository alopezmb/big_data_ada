...
MODELS_MOUNTPATH=os.getenv('MODELS_MOUNTPATH')
...
def main(base_path):
  ...
  # Save the bucketizer
  arrival_bucketizer_path = "{}/arrival_bucketizer_2.0.bin".format(MODELS_MOUNTPATH)
  ...
  vector_assembler_path = "{}/numeric_vector_assembler.bin".format(MODELS_MOUNTPATH)
